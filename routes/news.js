    ...
    function () {
      ...
      News.findAll({
        ...
        if (content.indexOf('<img') != -1) {
          ...
          var y = content.indexOf('>', content.indexOf('<img')) + 1;
          imgToReplace2 = content.substring(x, y);
          var removedImageContent = content.replace(imgToReplace2, "");
        } else {
