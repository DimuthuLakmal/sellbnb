...
router.get('/', function (req, res) {
  ...
  let api_methods_commodity = require('./commodity').methods;
  let api_methods_resentsearch = require('./recentsearch').methods;

  api_methods_commodity.viewPopular(function (commodityList) {
    api_methods_commodity.names(function (commodityNames) {
      api_methods_resentsearch.resentSearch(req, function (resentSearch) {
        require('./news').methods.viewlatest(function (latestNews) {
          require('./items').otherFunc.viewlatest(function (latestItems) {
            console.log('Index Page Visited');
            return res.render('index', {
              commodityNames: commodityNames,
              latestItems: latestItems,
              commodityPopular: commodityList,
              recentsearches: resentSearch,
...
router.get('/items/name/:name', function (req, res) {
  ...
  otherFunctions.getItem(req.params.name, user ? user.id : null, function (item) {
    require('./commodity').methods.names(function (commodityNames) {
