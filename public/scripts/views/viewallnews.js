$(document).ready(function () {
    ...
    jQuery.ajax({
        type: "GET",
        dataType: 'jsonp',
        url: "http://localhost:3000/api/news/viewpopular",
        success: function (obj, textstatus) {
            ...
            $.each(obj, function (index, news) {
                ...
                $('#popular_news').append('<li>' +
                    ...
                    '<a href="http://localhost:3000/news/id/'+news.id+'"><img src=\"'+imgSrc+'\" alt="" width="90"  height="90"/></a>' +
                    '</div>' +
                    '<div class="widget-text">' +
                    '<h4><a href="http://localhost:3000/news/id/'+news.id+'">'+news.title+'</a></h4>' +
    ...
    jQuery.ajax({
        type: "GET",
        dataType: 'jsonp',
        url: "http://localhost:3000/api/news/viewrecent",
        success: function (obj, textstatus) {
            //populating news by creating dynamic <li>'s
            $.each(obj, function (index, news) {
                var imgSrc = '';
